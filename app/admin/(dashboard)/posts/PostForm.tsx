...
import { POST_TYPE_ARTICLE, POST_TYPE_VIDEO } from "@/lib/post-types";
  ...
  return (
    <form action={action} className="space-y-6">
      ...
      <div>
        ...
        <input type="text" name="excerpt" id="excerpt" defaultValue={post?.excerpt ?? ""} maxLength={255} className={inputClass} />
      ...
      <div>
        ...
        <textarea name="body" id="body" rows={12} defaultValue={post?.body} required className={inputClass} />
      </div>
      ...
      <div>
        ...
        <input
          ...
          className={inputClass}
        />
        <p className="mt-1 text-[12px] text-[#94a3b8]">Auto-filled from the video thumbnail — override if you want a different image.</p>
        {thumbnail && (
