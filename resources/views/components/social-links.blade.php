@props(['class' => 'text-slate-500 dark:text-slate-500'])
...
@if (count($links))
    <div {{ $attributes->merge(['class' => "flex items-center gap-4 $class"]) }}>
        @if (isset($links['github']))
            <a href="{{ $links['github'] }}" target="_blank" rel="noopener" aria-label="GitHub" class="hover:text-slate-900 dark:hover:text-white transition">
        ...
        @if (isset($links['linkedin']))
            <a href="{{ $links['linkedin'] }}" target="_blank" rel="noopener" aria-label="LinkedIn" class="hover:text-slate-900 dark:hover:text-white transition">
        ...
        @if (isset($links['twitter']))
            <a href="{{ $links['twitter'] }}" target="_blank" rel="noopener" aria-label="Twitter / X" class="hover:text-slate-900 dark:hover:text-white transition">
        ...
        @endif
        @if (isset($links['telegram']))
            <a href="{{ $links['telegram'] }}" target="_blank" rel="noopener" aria-label="Telegram" class="hover:text-slate-900 dark:hover:text-white transition">
        ...
        @if (isset($links['email']))
            <a href="{{ $links['email'] }}" aria-label="Email" class="hover:text-slate-900 dark:hover:text-white transition">
