<x-site-layout :title="'Blog — ' . \App\Models\SiteSetting::current()->headline">
    ...
    <section class="relative overflow-hidden">
        ...
        <div class="anim-stagger max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-24 pb-12">
            ...
            <h1 class="text-4xl font-extrabold text-slate-900 dark:text-white">Blog</h1>
            <p class="mt-3 text-slate-600 dark:text-slate-400">Notes on projects, Laravel, and things I'm learning.</p>
        </div>
    </section>
