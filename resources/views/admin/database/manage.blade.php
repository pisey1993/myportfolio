        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
                                ...
                                <tr>
                                    <td class="px-6 py-3 font-mono text-gray-900 whitespace-nowrap">
                                        ...
                                        @if ($column['name'] === $primaryKey)
                                            <span class="ml-2 inline-flex px-2 py-0.5 rounded text-xs font-medium bg-[#2271b1]/10 text-[#2271b1]">primary</span>
                                        @endif
                                    </td>
            ...
            <div class="bg-white border border-[#c3c4c7] rounded-[4px] shadow-[0_1px_1px_rgba(0,0,0,.04)] p-6">
                ...
                <form method="POST" action="{{ route('admin.database.columns.store', $table) }}" class="grid grid-cols-12 gap-3 items-start">
                    ...
                    <div class="col-span-3">
                        <select name="type" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-[#2271b1] focus:ring-[#2271b1] text-sm">
                    ...
                    <div class="col-span-2 flex items-center gap-2 pt-2">
                        <input type="checkbox" name="nullable" value="1" checked class="rounded border-gray-300 text-[#2271b1] focus:ring-[#2271b1]">
                        <label class="text-sm text-gray-600">nullable</label>
                    </div>
                    <div class="col-span-12 flex justify-end pt-2">
                        <button type="submit" class="px-5 py-2 rounded-md bg-[#2271b1] text-white text-sm font-medium hover:bg-[#135e96]">Add Column</button>
                    </div>
                </form>
            </div>

            @if ($table !== 'migrations')
                <div class="bg-white border border-[#c3c4c7] rounded-[4px] shadow-[0_1px_1px_rgba(0,0,0,.04)] p-6 border border-red-100">
