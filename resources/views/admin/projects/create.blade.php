<x-app-layout>
    <x-slot name="header">
        <h1 class="text-2xl font-normal text-[#1d2327]">New Project</h1>
    </x-slot>
            ...
            <div class="bg-white border border-[#c3c4c7] rounded-[4px] shadow-[0_1px_1px_rgba(0,0,0,.04)] p-6">
                <form method="POST" action="{{ route('admin.projects.store') }}" class="space-y-6">
                    ...
                    <div class="flex justify-end gap-3">
                        ...
                        <button type="submit" class="px-5 py-2.5 rounded-md bg-[#2271b1] text-white text-sm font-medium hover:bg-[#135e96]">Create Project</button>
                    </div>
                </form>
            </div>
        </div>
